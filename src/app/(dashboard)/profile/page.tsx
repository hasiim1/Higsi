...
export default function ProfilePage() {
  ...
  return (
    <div className="flex-1 bg-bg-dark flex flex-col pb-12 relative min-h-screen">
      <Header
        title="My Profile"
        subtitle="Manage your scholarly persona. Customize details and upload profile photos."
        showSearch={false}
      />
        ...
        <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 mt-3 text-xs text-text-secondary">
                  <div className="flex items-center gap-1.5 bg-primary/10 border border-primary/20 text-primary px-3 py-1 rounded-full font-bold">
                    <Flame
                      size={14}
                      className="fill-current text-primary animate-pulse"
                    />
          ...
          <div className="bg-card-dark border border-border-dark rounded-3xl p-6 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-text-secondary mb-1.5">
                  Username (Lower-case alphanumeric)
                </label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-sm font-semibold text-text-muted font-outfit">
                    @
                  </span>
                  <input
                    type="text"
                ...
                <p className="text-[10px] text-text-muted mt-1">
                  Used to identify your learning persona locally and in logs.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex justify-between items-center text-[10px] text-text-muted mt-1">
                  <span>
                    Describe your study goals and scholarly objectives.
                  </span>
